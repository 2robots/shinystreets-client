...
angular.module('shinystreets.CreateSolutionCtrl', [])

.controller('CreateSolutionCtrl', function($scope, $rootScope, $ionicActionSheet, $ionicLoading, $ionicPopup, FileUploader) {
  ...
  $scope.closeCreateSolution = function(){
    $scope.solution = {};
